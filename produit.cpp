...
bool produit::modifierp(){
    QSqlQuery query1;
    query1.prepare("UPDATE produit set nomp=:nomp,quantité=:quantity,prix=:prix,idc=:idc WHERE idp=:idp");
...
QSqlQueryModel * produit::afficherp_tri_identifiant(){

    QSqlQueryModel * query = new QSqlQueryModel();
    query->setQuery("select * from produit ORDER BY idp");
    query->setHeaderData(0,Qt::Horizontal,QObject::tr("IdentifiantP"));
    query->setHeaderData(1,Qt::Horizontal,QObject::tr("NomP"));
    query->setHeaderData(2,Qt::Horizontal,QObject::tr("Quantité"));
    query->setHeaderData(3,Qt::Horizontal,QObject::tr("Prix"));
...
QSqlQueryModel * produit::afficherp_tri_quantity(){

    QSqlQueryModel * query = new QSqlQueryModel();
    query->setQuery("select * from produit ORDER BY quantité");
    query->setHeaderData(0,Qt::Horizontal,QObject::tr("IdentifiantP"));
    query->setHeaderData(1,Qt::Horizontal,QObject::tr("NomP"));
    query->setHeaderData(2,Qt::Horizontal,QObject::tr("Quantité"));
    query->setHeaderData(3,Qt::Horizontal,QObject::tr("Prix"));
...
QSqlQueryModel * produit::rechercher_dynamique_produit(QString p){

    QSqlQueryModel * query = new QSqlQueryModel();
    query->setQuery("select * from produit where idp like '"+p+"%' or nomp like '"+p+"%' or quantité like '"+p+"%' or prix like '"+p+"%' or idc like '"+p+"%' ");
    query->setHeaderData(0,Qt::Horizontal,QObject::tr("IdentifiantP"));
    query->setHeaderData(1,Qt::Horizontal,QObject::tr("NomP"));
    query->setHeaderData(2,Qt::Horizontal,QObject::tr("Quantité"));
    query->setHeaderData(3,Qt::Horizontal,QObject::tr("Prix"));
